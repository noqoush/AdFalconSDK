...
Pod::Spec.new do |s|
  s.name             = 'AdFalconSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AdFalconSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/emad/AdFalconSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'emad' => 'emadz@noqoush.com' }
  s.source           = { :git => 'https://github.com/emad/AdFalconSDK.git', :tag => s.version.to_s }
